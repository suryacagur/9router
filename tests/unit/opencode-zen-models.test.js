...
const CHAT_ONLY = ["deepseek-v4-pro", "deepseek-v4-flash", "deepseek-v4-flash-vision-exp", "deepseek-v4.1-flash",
  ...
  "big-pickle", "space-bunny-free", "qwen3.8-max", "deepseek-v4-flash-free",
...
const CLAUDE_CAPABLE = ["claude-fable-5", "claude-fable-5-1", "claude-opus-5", "claude-opus-5-5",
  "claude-opus-4-8", "claude-opus-4-7", "claude-opus-4-6", "claude-opus-4-5",
  "claude-sonnet-5", "claude-sonnet-4-6", "claude-sonnet-4-5", "claude-sonnet-4",
  "claude-haiku-4-5", "qwen3.8-flash", "qwen3.6-plus", "qwen3.5-plus", "union-alpha"];
// Models that also expose the OpenAI /responses endpoint
const RESPONSES_CAPABLE = ["gpt-6-astra", "gpt-6-sol", "gpt-6-luna",
